    ...
    public static IEnumerable<object[]> TestDataOneCorner
    {
        get
        {
            ...
            yield return new object[]
            {
                ...
                new ReferenceArea(new RowCol(ReferenceAxisType.None, 0, ReferenceAxisType.Relative, 0, R1C1)),
            };
            ...
            yield return new object[]
            {
                "C[-14]",
                new[] { Token.A1_SPAN_REFERENCE },
                new ReferenceArea(new RowCol(ReferenceAxisType.None, 0, ReferenceAxisType.Relative, -14, R1C1))
            };
            ...
            yield return new object[]
            {
                "C75",
                new[] { Token.A1_SPAN_REFERENCE },
                new ReferenceArea(new RowCol(ReferenceAxisType.None, 0, ReferenceAxisType.Absolute, 75, R1C1))
            };
            ...
            yield return new object[]
            {
                "R",
                new[] { Token.A1_SPAN_REFERENCE },
                new ReferenceArea(new RowCol(ReferenceAxisType.Relative, 0, ReferenceAxisType.None, 0, R1C1))
            };
            ...
            yield return new object[]
            {
                "R[-14]",
                new[] { Token.A1_SPAN_REFERENCE },
                new ReferenceArea(new RowCol(ReferenceAxisType.Relative, -14, ReferenceAxisType.None, 0, R1C1))
            };
            ...
            yield return new object[]
            {
                "R75",
                new[] { Token.A1_SPAN_REFERENCE },
                new ReferenceArea(new RowCol(ReferenceAxisType.Absolute, 75, ReferenceAxisType.None, 0, R1C1))
            };
            ...
            yield return new object[]
            {
                "RC",
                new[] { Token.A1_CELL },
                new ReferenceArea(new RowCol(ReferenceAxisType.Relative, 0, ReferenceAxisType.Relative, 0, R1C1))
            };
            ...
            yield return new object[]
            {
                "R[7]C2",
                new[] { Token.A1_CELL },
                new ReferenceArea(new RowCol(ReferenceAxisType.Relative, 7, ReferenceAxisType.Absolute, 2, R1C1))
            };
            ...
            yield return new object[]
            {
                "R812C[7]",
                new[] { Token.A1_CELL },
                new ReferenceArea(new RowCol(ReferenceAxisType.Absolute, 812, ReferenceAxisType.Relative, 7, R1C1))
            };
        }
    }

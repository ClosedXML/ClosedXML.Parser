...
public class RefAtomExpressionRuleTests
{
    ...
    {
        VerifyNode("A1", new ReferenceNode(new ReferenceSymbol(1, 1, A1)));
    }
    ...
    public void Ref_function_call()
    {
        VerifyNode("IF(TRUE,B5)", new FunctionNode("IF")
        {
            ...
            {
                new ValueNode(true),
                new ReferenceNode(new ReferenceSymbol(5, 2, A1))
            }
        });
    }
    ...
    {
        VerifyNode("Sheet1:Sheet3!A1", new Reference3DNode("Sheet1", "Sheet3", new ReferenceSymbol(1, 1, A1)));
    }

    [Fact]
    public void Sheet_reference_can_have_whitespace_after_exclamation_mark()
    {
        VerifyNode("Sheet2!  A1", new SheetReferenceNode("Sheet2", new ReferenceSymbol(1, 1, A1)));
    }
